              ...
              <div className="px-4 pb-4 pt-2 space-y-4">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-baseline">
                    <Label className="text-xs font-normal text-muted-foreground">Technologies & Tools Used</Label>
                ...
                <div className="relative group">
                  <Input
                    ...
                    className="w-full bg-white border-dia-divider rounded-dia-btn h-8
                      focus:border-foreground/40 focus:ring-1 focus:ring-foreground/10
                      hover:border-border hover:bg-white transition-colors text-sm"
