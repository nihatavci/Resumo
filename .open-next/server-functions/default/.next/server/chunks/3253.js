"use strict";exports.id=3253,exports.ids=[3253],exports.modules={66548:(e,t,n)=>{n.d(t,{A:()=>i});let i=(0,n(27503).A)("CircleAlert",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]])},35978:(e,t,n)=>{n.d(t,{BT:()=>l,Wu:()=>d,ZB:()=>c,Zp:()=>o,aR:()=>s});var i=n(35968),a=n(3425),r=n(80463);let o=a.forwardRef(({className:e,...t},n)=>(0,i.jsx)("div",{ref:n,className:(0,r.cn)("rounded-xl border bg-card text-card-foreground shadow",e),...t}));o.displayName="Card";let s=a.forwardRef(({className:e,...t},n)=>(0,i.jsx)("div",{ref:n,className:(0,r.cn)("flex flex-col space-y-1.5 p-6",e),...t}));s.displayName="CardHeader";let c=a.forwardRef(({className:e,...t},n)=>(0,i.jsx)("div",{ref:n,className:(0,r.cn)("font-semibold leading-none tracking-tight",e),...t}));c.displayName="CardTitle";let l=a.forwardRef(({className:e,...t},n)=>(0,i.jsx)("div",{ref:n,className:(0,r.cn)("text-sm text-muted-foreground",e),...t}));l.displayName="CardDescription";let d=a.forwardRef(({className:e,...t},n)=>(0,i.jsx)("div",{ref:n,className:(0,r.cn)("p-6 pt-0",e),...t}));d.displayName="CardContent",a.forwardRef(({className:e,...t},n)=>(0,i.jsx)("div",{ref:n,className:(0,r.cn)("flex items-center p-6 pt-0",e),...t})).displayName="CardFooter"},64603:(e,t,n)=>{n.d(t,{aJ:()=>h,Zm:()=>g,Ch:()=>v});var i=n(3425);let a={role:"system",content:`You are ResumeLM, an expert system specialized in parsing, structuring, and enhancing resume presentation while maintaining ABSOLUTE content integrity.
...
Remember: Your primary role is to ensure COMPLETE preservation of ALL content while enhancing presentation. You are a professional formatter who must retain every single detail from the original content.`},r={role:"system",content:`You are an expert ATS-optimized resume writer with deep knowledge of modern resume writing techniques and industry standards. Your task is to generate powerful, metrics-driven bullet points for work experiences that will pass both ATS systems and impress human recruiters.
...
Remember: Each bullet point should tell a compelling story of achievement and impact while remaining truthful and verifiable. Use bold formatting (**keyword**) to emphasize key technologies, metrics, and achievements.`},o={role:"system",content:`You are an expert ATS-optimized resume bullet point improver. Your task is to enhance a single work experience bullet point while maintaining its core message and truthfulness.
...
Remember: Your goal is to enhance clarity and impact while maintaining absolute truthfulness. When in doubt, be conservative with improvements. Always use **keyword** syntax to bold important terms, metrics, and achievements.`},s={role:"system",content:`You are an expert ATS-optimized resume writer specializing in project descriptions. Your task is to generate compelling, technically detailed bullet points for projects that will impress both ATS systems and technical recruiters.
...
Remember: Each bullet point should demonstrate technical expertise and problem-solving ability while remaining truthful and verifiable. Use **keyword** syntax to emphasize important technical terms, metrics, and achievements.`},c={role:"system",content:`You are an expert ATS-optimized resume project bullet point improver. Your task is to enhance a single project bullet point while maintaining its core message and truthfulness.
...
Remember: Your goal is to enhance technical clarity and impact while maintaining absolute truthfulness. Focus on technical achievements, performance improvements, and architectural decisions. Always use **keyword** syntax to bold important technical terms, metrics, and achievements.`},l={role:"system",content:`You are ResumeLM, an advanced AI assistant specialized in resume crafting and optimization. You follow a structured chain-of-thought process for every task while maintaining access to resume modification functions.
 ...
 `},d={role:"system",content:`You are a specialized AI assistant whose purpose is to analyze text provided by users--such as resumes, GitHub profiles, LinkedIn content, or project descriptions--and generate a polished, professional resume. Follow these guidelines:
...
`},m=new Set,u={},p=u,h={aiAssistant:l.content,workExperienceGenerator:r.content,workExperienceImprover:o.content,projectGenerator:s.content,projectImprover:c.content,textAnalyzer:d.content,resumeFormatter:a.content},g={aiAssistant:{name:"AI Chat Assistant",description:"The system prompt used for the main chat assistant that helps you optimize your resume."},workExperienceGenerator:{name:"Work Experience Generator",description:"Used when generating new bullet points for work experiences."},workExperienceImprover:{name:"Work Experience Improver",description:"Used when improving existing work experience bullet points."},projectGenerator:{name:"Project Generator",description:"Used when generating new bullet points for projects."},projectImprover:{name:"Project Improver",description:"Used when improving existing project bullet points."},textAnalyzer:{name:"Text Analyzer",description:"Used when importing text content and extracting professional information."},resumeFormatter:{name:"Resume Formatter",description:"Used when formatting and structuring resume content from raw text."}};function f(e){return m.add(e),()=>{m.delete(e)}}function E(){return u}function y(){return u}function v(){let e=(0,i.useSyncExternalStore)(f,E,y),t=(0,i.useCallback)(e=>{let t=p,n=function(e){let t={};for(let n of["aiAssistant","workExperienceGenerator","workExperienceImprover","projectGenerator","projectImprover","textAnalyzer","resumeFormatter"])"string"==typeof e[n]&&e[n]&&(t[n]=e[n]);return t}("function"==typeof e?e(t):e);!function(e,t){if(e===t)return!0;let n=Object.keys(e),i=Object.keys(t);if(n.length!==i.length)return!1;for(let i of n)if(e[i]!==t[i])return!1;return!0}(t,n)&&(p=n,m.forEach(e=>e()))},[]),n=(0,i.useCallback)((e,n)=>{t(t=>{if(void 0===n||n===h[e]){let{[e]:n,...i}=t;return i}return{...t,[e]:n}})},[t]),a=(0,i.useCallback)(e=>{t(t=>{let{[e]:n,...i}=t;return i})},[t]),r=(0,i.useCallback)(()=>{t({})},[t]),o=(0,i.useCallback)(t=>e[t]??h[t],[e]),s=(0,i.useCallback)(t=>t in e,[e]);return{customPrompts:e,setCustomPrompts:t,setPrompt:n,resetPrompt:a,resetAllPrompts:r,getPrompt:o,isCustomized:s}}}};